 ...
 */
  ...
  QK_RBT,   KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,                    MS_BTN1, MS_UP, MS_LEFT, MS_BTN2, KC_NO, KC_NO,
  UG_TOGG, UG_HUEU,UG_SATU, UG_VALU, KC_COLEMAKDH,KC_COLEMAK,             C(G(KC_LEFT)),MS_DOWN,MS_RGHT,C(G(KC_RGHT)),KC_NO, KC_NO,
  UG_NEXT, UG_HUED,UG_SATD, UG_VALD, CG_TOGG,KC_QWERTY,KC_TRNS,   KC_NO, KC_NO, KC_MPRV, KC_MPLY, KC_MNXT, KC_NO, KC_NO,
                   KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,     KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS
),
/* NUMPAD
 * ,-----------------------------------------.                    ,-----------------------------------------.
